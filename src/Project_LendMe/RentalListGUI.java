 ...
 * @author Anja
 */
public class RentalListGUI extends javax.swing.JFrame {

    /**
     * Creates new form GUI
     */
    public RentalListGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RentalListGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RentalListGUI().setVisible(true);
            }
        });
    }
